...
* said current to show what is actually being taken. It also measures voltage of the power source
* vs time to allow the data to be processed into a discharge curve.
*/

//Pins
const int vset = 9; //Used to control current load circuit based on user input
const int iread = A4; 
const int volt = A3; //Voltage measurement analog pin
...
//These variables store voltage vs time
...
void loop() {
  ...
  //Measure the battery voltage and time
